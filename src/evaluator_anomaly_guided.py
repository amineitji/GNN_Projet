...
class AnomalyEvaluatorWithLinkGuidance:
    ...
    def get_anomalous_links(self, embeddings, threshold=0.7, top_k=50):
        """
        ⭐ AMÉLIORÉ : Retourne les liens les plus suspects avec analyse détaillée

        Args:
            threshold: Seuil de score pour considérer un lien comme suspect
            top_k: Nombre de liens à retourner
        """
